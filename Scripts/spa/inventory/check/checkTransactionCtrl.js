(function (app) {
    ...
    app.controller('checkTransactionCtrl', checkTransactionCtrl);

    checkTransactionCtrl.$inject = ['$scope', '$rootScope', '$timeout', '$modal', 'settings', 'apiService', 'notificationService', 'membershipService'];

    function checkTransactionCtrl($scope, $rootScope, $timeout, $modal, settings, apiService, notificationService, membershipService) {
        $rootScope.Details = [];

        $scope.pageClass = 'page-checktransaction';
        ...
        $scope.pageTransPrefix = 'spa.inventory.checktransaction.';
        ...
        $scope.setCountReq = function () {
        }

        $scope.clearCountReq = function () {
        }

        $scope.requireAudit = function () {
        }
